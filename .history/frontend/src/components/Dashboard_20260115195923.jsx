...
import MissionReportButton from './MissionReportButton';  // ← PART 11: NEW IMPORT
...
const Dashboard = () => {
  ...
  const [activeAlerts, setActiveAlerts] = useState([]);  // ← PART 11: NEW STATE
  ...
  // ← PART 11: Handle alerts updates from AlertsDecisionPanel
