...
export default function MapView({ detections, sprayPath }) {
  ...
  // Map style URLs - Using positron as base for both modes
  const mapStyles = {
    streets: 'https://tiles.openfreemap.org/styles/positron',
    satellite: 'https://tiles.openfreemap.org/styles/positron' // Use base style, satellite tiles added via Source
  };
                ...
                >
                  <div className="marker-popup">
                    ...
                    <div className="popup-detail">
                      ...
                      <span className="popup-value" style={{ color: '#0d5540' }}>Active</span>
                    </div>
                  </div>
                </Popup>
              )}
