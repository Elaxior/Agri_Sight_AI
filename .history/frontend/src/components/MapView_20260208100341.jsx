...
export default function MapView({ detections, sprayPath }) {
  ...
  const [mapStyle, setMapStyle] = useState('streets'); // streets, satellite, terrain, dark
  const mapRef = useRef();
  ...
  const mapStyles = {
    ...
    satellite: 'https://tiles.openfreemap.org/styles/liberty', // We'll enhance this
    terrain: 'https://tiles.openfreemap.org/styles/positron',
    dark: 'https://tiles.openfreemap.org/styles/dark'
  };

  const getMapStyleUrl = () => {
    if (mapStyle === 'satellite') {
      // For satellite, we'll use a base style and add satellite tiles
    ...
    <div className="map-view-panel">
      ...
      <div className="map-container">
        ...
        >
          ...
          {/* Satellite imagery overlay (when satellite mode is active) */}
          {mapStyle === 'satellite' && (
            <Source
              id="satellite"
              type="raster"
