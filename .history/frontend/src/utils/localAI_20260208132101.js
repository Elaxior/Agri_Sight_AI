...
const knowledgeBase = [
  ...
  {
    patterns: [
      /what (is|does) (this|the) (system|dashboard|application|app)/i,
      /tell me about (this|the) system/i,
      /how does (this|the) system work/i,
      /system overview/i,
      /what can (this|the) system do/i
    ],
  ...
  {
    patterns: [
      /what diseases (can|does) (it|this|the system) detect/i,
      /which diseases (are|can be) detected/i,
  ...
  {
    patterns: [
      /(how|what is) (accurate|accuracy)/i,
      /confidence (level|score)/i,
      /how reliable/i,
      /model performance/i,
  ...
  {
    patterns: [
      /(economic|financial) (impact|analysis|benefits?)/i,
      /roi|return on investment/i,
      /cost (savings?|benefits?)/i,
      /how much (money|can i save)/i,
      /worth (it|the investment)/i
    ],
  ...
  {
    patterns: [
      /drone (position|location|tracking)/i,
      /gps (data|tracking|coordinates)/i,
      /where is (the )?drone/i,
      /track drone/i,
      /drone status/i
    ],
  ...
  {
    patterns: [
      /spray (path|plan|planning|route)/i,
      /how (to|does) spray/i,
      /treatment (path|plan|route)/i,
      /optimal (spray|treatment)/i,
  ...
  {
    patterns: [
      /upload (video|footage)/i,
      /how (to|do i) (upload|analyze) (video|footage)/i,
      /process (video|footage)/i,
      /video (analysis|input)/i,
      /analyze (my|the) (video|footage)/i
    ],
  ...
  {
    patterns: [
      /(help|error|problem|issue|not working|fix)/i,
      /troubleshoot/i,
      /(why|what) (is|does) (not|isn't) (work|load|show)/i,
      /connection (error|failed|lost)/i,
      /(backend|server|api) (down|not responding)/i
    ],
  ...
  {
    patterns: [
      /(how much|cost|price|pricing)/i,
      /hardware (requirements?|needed|specs?)/i,
      /what (drone|camera|sensors?) (do i need|required)/i,
      /compatible (drones?|hardware)/i
    ],
  ...
  {
    patterns: [
      /features?|capabilities|what (can|does) (it|this) do/i,
      /list (of )?features?/i,
      /functionality/i,
      /key features?/i
    ],
