...
def clear_local_data():
    """Clear old detection files before new analysis."""
    try:
        ...
        print(f"⚠️ Warning: Could not clear local data: {e}")
...
def run_inference_background(video_path):
    ...
    try:
        ...
        # Use local inference script (no Firebase required)
        script_path = BASE_DIR / "src" / "run_inference_local.py"
